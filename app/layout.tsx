            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex justify-center sm:justify-start space-x-4">
                  ...
                  <Link href="https://www.linkedin.com/company/neolumina/" className="hover:text-gray-300 transition-colors" title="LinkedIn">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link href="https://www.facebook.com/61576880407117" className="hover:text-gray-300 transition-colors" title="Facebook">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
